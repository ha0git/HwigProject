...
body {height:100%;min-height:100%;font-size:16px;color:#737373;line-height:1.5}
...
input, textarea, select, button {font-size:16px;color:#919090;line-height:1.5;letter-spacing:0;vertical-align:middle; background:none; border:none;}
